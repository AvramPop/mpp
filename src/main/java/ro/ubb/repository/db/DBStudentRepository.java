...
public class DBStudentRepository extends DBRepository<Long, Student> {
  ...
  public Optional<Student> findOne(Long aLong) {
    ...
    String selectQuery = "select student_id, serial_number, group_number, name from "+this.tableName+" where student_id = " +
            aLong;
  ...
  public Iterable<Student> findAll() {
    ...
    String selectQuery = "select student_id, serial_number, group_number, name from "+this.tableName;
  ...
  public Optional<Student> update(Student entity) throws ValidatorException {
    ...
    String updateQuery = "update "+this.tableName+" set serial_number = ?, group_number = ?, name = ? where student_id = ?";
    try(Connection connection = dbConnection()){
