...
public class LabProblemServerService implements LabProblemService {
  @Override
  public Future<LabProblem> addLabProblem(Long id, int problemNumber, String description) throws ValidatorException{
    return null;
  }
  ...
  @Override
  public Future<LabProblem> updateLabProblem(Long id, int problemNumber, String description) throws ValidatorException{
    return null;
  }
//
