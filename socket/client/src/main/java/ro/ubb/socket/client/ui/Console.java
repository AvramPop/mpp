...
public class Console {
  //  private StudentServerService studentService;
  //  private LabProblemServerService labProblemService;
  //  private AssignmentServerService assignmentService;
  //  private HashMap<String, Runnable> dictionaryOfCommands;
  //
  //  public Console(
  //      StudentServerService studentService,
  //      LabProblemServerService labProblemService,
  //      AssignmentServerService assignmentService) {
